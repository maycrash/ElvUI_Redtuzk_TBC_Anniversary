...
function RUI:Ping()	
	...
	--WoW API / Variables (Updated for TBC Anniversary 2.5.5)
	local GetAddOnCPUUsage = C_AddOns.GetAddOnCPUUsage or GetAddOnCPUUsage
	local GetAddOnInfo = C_AddOns.GetAddOnInfo or GetAddOnInfo
	local GetAddOnMemoryUsage = C_AddOns.GetAddOnMemoryUsage or GetAddOnMemoryUsage
	...
	DT:RegisterDatatext('Ping', nil, nil, BuildAddonList, Update, Click, OnEnter, OnLeave, L["Ping"])
end
