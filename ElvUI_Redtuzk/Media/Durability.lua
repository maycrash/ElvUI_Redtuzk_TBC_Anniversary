...
function RUI:Durability()
	...
	DT:RegisterDatatext('MyndDurability', nil, {"UPDATE_INVENTORY_DURABILITY", "MERCHANT_SHOW"}, OnEvent, nil, Click, OnEnter, nil, L["Mynd Durability"])
end
